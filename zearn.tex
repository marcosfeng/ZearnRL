...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{zearn_files/figure-pdf/parameter-correlations-1.pdf}}

}

\caption{Correlation between individual parameter estimates from
non-hierarchical (Matlab) and hierarchical (Stan) estimation approaches.
Each point represents one teacher. Correlation values are Spearman's
rho, with asterisks indicating p \textless{} 0.001.}
...
\\[-1.8ex] & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)}\\ 
\hline \\[-1.8ex] 
 $\alpha$ & 0.062^{***} & 0.060^{***} & 0.063^{***} \\ 
  & (0.015) & (0.015) & (0.015) \\ 
  & & & \\ 
 $\gamma$ & -0.032 & -0.045^{**} & -0.044^{*} \\ 
  & (0.017) & (0.017) & (0.017) \\ 
  & & & \\ 
 $\tau$ & -0.039^{*} & -0.098^{***} & -0.090^{***} \\ 
  & (0.016) & (0.025) & (0.026) \\ 
  & & & \\ 
...
Control for Poverty Level &  &  & Yes \\ 
Observations & \multicolumn{1}{c}{1,782} & \multicolumn{1}{c}{1,782} & \multicolumn{1}{c}{1,668} \\ 
R$^{2}$ & \multicolumn{1}{c}{0.086} & \multicolumn{1}{c}{0.171} & \multicolumn{1}{c}{0.226} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.083} & \multicolumn{1}{c}{0.167} & \multicolumn{1}{c}{0.217} \\ 
Residual Std. Error & \multicolumn{1}{c}{0.538 (df = 1776)} & \multicolumn{1}{c}{0.513 (df = 1772)} & \multicolumn{1}{c}{0.504 (df = 1649)} \\ 
F Statistic & \multicolumn{1}{c}{33.449$^{***}$ (df = 5; 1776)} & \multicolumn{1}{c}{40.660$^{***}$ (df = 9; 1772)} & \multicolumn{1}{c}{26.685$^{***}$ (df = 18; 1649)} \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{3}{r}{$^{*}$p$<$0.05; $^{**}$p$<$0.01; $^{***}$p$<$0.001} \\ 
\end{tabular} 
...
\pandocbounded{\includegraphics[keepaspectratio]{zearn_files/figure-pdf/fig-corr-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/student-feed.PNG}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/PD-calendar.jpg}}
