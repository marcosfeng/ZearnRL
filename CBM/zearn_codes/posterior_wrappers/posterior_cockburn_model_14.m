function [loglik, prob, choice] = posterior_cockburn_model_14(parameters, subj)
    subj.action = subj.NNDSVD_teacher2;
    subj.outcome = subj.NNDSVD_student4;
    [subj.ev, subj.sd] = calculate_ev_uncertainty(subj.action, subj.outcome);
    [loglik, prob, choice] = cockburn_posterior(parameters, subj);
end
