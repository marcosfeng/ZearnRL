...
wrapper_function_3_ql = str2func('wrapper_function_3');
path(wrapperPath);
% Define function handles for Actor-Critic wrapper functions
wrapperPath = addpath(fullfile('..','zearn_codes','ac_wrappers'));
wrapper_function_43_ac = str2func('wrapper_function_43');
wrapper_function_15_ac = str2func('wrapper_function_15');
path(wrapperPath);

fname_template = {
    'comp_results/lap_logit7_%d.mat', ... % Logit
    'comp_results/lap_logit3_%d.mat', ...
    'comp_results/lap_logit43_%d.mat', ...
    'comp_results/lap_logit15_%d.mat', ...
    'comp_results/lap_ql7_%d.mat', ... % Q-learning
    'comp_results/lap_ql3_%d.mat', ...
    'comp_results/lap_ac43_%d.mat', ... % Actor-Critic
    'comp_results/lap_ac15_%d.mat', ...
    'comp_results/lap_hybrid7_%d.mat', ... % Logit Hybrid
    'comp_results/lap_hybrid3_%d.mat', ... 
    'comp_results/lap_hybrid43_%d.mat', ... 
    'comp_results/lap_hybrid15_%d.mat', ... 
    'comp_results/lap_hybrid3_15_%d.mat', ... % RL Hybrid
    'comp_results/lap_hybrid7_43_%d.mat'};
models = {
    @logit_wrapper_7, ...
    @logit_wrapper_3, ...
    @logit_wrapper_43, ...
    ...
    wrapper_function_3_ql, ...
    wrapper_function_43_ac, ...
    wrapper_function_15_ac, ...
    @hybrid_wrapper_7, ...
    @hybrid_wrapper_3, ...
    @hybrid_wrapper_43, ...
    @hybrid_wrapper_15, ...
...
fname = {'comp_aggr_results/lap_logit7.mat', ...
    ...
    'comp_aggr_results/lap_logit43.mat', ...
    'comp_aggr_results/lap_logit15.mat', ...
    'comp_aggr_results/lap_ql7.mat', ... % Q-learning
    'comp_aggr_results/lap_ql3.mat', ...
    'comp_aggr_results/lap_ac43.mat', ... % Actor-Critic
    'comp_aggr_results/lap_ac15.mat', ...
    'comp_aggr_results/lap_hybrid7.mat', ... % Hybrid
    'comp_aggr_results/lap_hybrid3.mat', ... 
    'comp_aggr_results/lap_hybrid43.mat', ... 
    'comp_aggr_results/lap_hybrid15.mat', ... 
    'comp_aggr_results/lap_hybrid3_15.mat', ... 
    'comp_aggr_results/lap_hybrid7_43.mat'};
...
fname_hbi = {'comp_aggr_results/hbi_compare_7.mat', ...
    ...
    'comp_aggr_results/hbi_compare_43.mat', ...
    'comp_aggr_results/hbi_compare_15.mat'};
idx = [1,5,9,14;
    2,6,10,13;
    3,7,11,14;
    4,8,12,13];
