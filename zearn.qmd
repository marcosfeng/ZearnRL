...
<!-- This section loads the prediction data from various models and prepares it for further analysis -->
...
<!-- This section prepares data for comparing different models' performance -->
...
models <- c("q_model", "logit_model", "cockburn_model",
            "q_model_simple", "baseline_model")
model_names <- c("Q-learning", "Lau & Glimcher",
                 "Cockburn et al.",
                 "Q-learning (cost-free)", "Baseline")
...
# Rename columns
colnames(model_comparison_df)[3:7] <- model_names
...
models <- c("q_model", "logit_model", "cockburn_model", "q_model_simple", "baseline_model")
model_names <- c("Q-learning", "Lau & Glimcher", "Cockburn et al.", "Q-learning (cost-free)", "Baseline")
n_par <- c(5, 5, 6, 3, 1)
...
for (i in seq_along(models)) {
  file_path <- file.path(model_folder_path, sprintf("lap_aggr_%s_%d.mat", models[i], wrapper))
  if (file.exists(file_path)) {
    mat_data <- readMat(file_path)
