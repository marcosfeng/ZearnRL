...
pca_3 <- results_list[["PCA"]][["3"]]
ae_3 <- results_list[["Autoencoder"]][["3"]]
df_components <- df %>%
  bind_cols(pca_3)
names(df_components)[c((ncol(df_components)-2):ncol(df_components))] <- paste0("PC", 1:3)
df_components <- df_components %>%
  bind_cols(ae_3)
names(df_components)[c((ncol(df_components)-2):ncol(df_components))] <- paste0("AE", 1:3)
