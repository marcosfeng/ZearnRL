...
To operationalize these models, we used the NMF components and constructed their lagged versions to capture temporal dynamics, extending up to six weeks to determine the optimal lag. This lag value captured how far back rewards and past actions matter in influencing teacher behavior on the platform.
