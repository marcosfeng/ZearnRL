...
#| fig-cap: "Heatmap of Non-negative Matrix Factorization (NMF) components for teacher and student data. The rows represent the original variables, while the columns correspond to the individual components. The color gradient from light to dark indicates the increasing weights or importance of variables within each component."
#| fig-subcap:
